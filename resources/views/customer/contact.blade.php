    ...
    <footer class="container-fluid p-0 pr-0" style="">
        <div class="row mr-0 ml-0">
            <div class="col-md-6 pr-0 pl-0 map">
                <iframe src="{{$value->link}}"  style="border:0" allowfullscreen></iframe>
            </div>
            <div class="col-md-6 content-us">
                <form action="/customer/contact/submit" method="post" class="contact-form" id="contact">
                    ...
                    @endif
                    @csrf
                    <marquee style="margin-top: 10px; margin-bottom: 10px; color: black; background: linear-gradient(dodgerblue,white); border-radius: 15px; font-family: 'Adobe Arabic'; font-size: 18px">{{$value->message}}</marquee>
                    <h3 class="text-uppercase">Contact Us</h3>
                    <input type="text" class="form-control" name="mobile" placeholder="Your Mobile" :maxlength="11" :minlength="11" required>
